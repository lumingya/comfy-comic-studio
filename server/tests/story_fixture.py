...
SCENES = [
    {
        ...
        "location": "深夜的办公室",
        "time": "night",
        "tags": ["office", "indoors", "desk", "computer"],
    ...
    },
    {
        ...
        "location": "便利店",
        "time": "night",
        "tags": ["convenience store", "indoors", "shelves"],
    ...
    },
    {
        ...
        "location": "雨夜街头",
        "time": "night",
        "tags": ["street", "rain", "outdoors", "umbrella"],
...
def make_story(panels: int = 12) -> dict:
    ...
    for i in range(panels):
        ...
        if i % 4 == 3:
            cast.append(
                {"id": "zhou", "expression": "smile", "action": "waving", "tags": ["waving"]}
            )
        dialogue = (
            [{"speaker": "narrator", "kind": "narration", "text": "凌晨两点。"}]
            if i == 0
            else [{"speaker": "lin", "kind": "speech", "text": "又是你啊。"}]
            if i % 2
            else []
        )
        items.append(
