...
function renderHome() {
  return `<section id="mio-home" aria-labelledby="home-title">
    <header class="home-hero"><div class="home-intro"><div class="home-eyebrow"><span></span>MIO / A LOCAL-FIRST COMIC STUDIO</div><h1 id="home-title"><span>让故事成帧，</span><span class="home-title-accent">让灵感成册。</span></h1><p class="home-lead">Mio 是一间运行在你电脑上的漫画工作室：写下分镜与角色，接入 ComfyUI、NovelAI 或 OpenAI 兼容服务，一次生成整本画册，再逐页阅读、导出与分享。</p><div class="home-hero-actions">${btn('从一幕开始','plus','home-open','data-route="1" data-view="stories"','primary')}${btn(bookBy(guidePreferences().practiceBookId)?.status==='complete'?'打开离线练习画册':'先用离线练习体验','play','guide-practice',releaseUI.practiceBusy?'disabled':'')}${btn('浏览我的画册','arrow','home-open','data-route="0"','ghost')}</div><p class="home-reassurance">无需先连接模型，也可以编辑分镜与阅读画册。</p></div>${homeArtwork()}</header>
