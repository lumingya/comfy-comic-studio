...
function homeArtwork() {
  return `<div class="home-art" aria-hidden="true"><svg viewBox="0 0 420 320" fill="none"><defs><linearGradient id="home-paper" x1="100" y1="20" x2="320" y2="300" gradientUnits="userSpaceOnUse"><stop stop-color="var(--home-paper)"/><stop offset="1" stop-color="var(--home-paper-shade)"/></linearGradient></defs><ellipse cx="220" cy="278" rx="148" ry="19" fill="currentColor" opacity=".06"/><path d="M39 243 348 69M63 57 375 254" stroke="currentColor" stroke-opacity=".14"/><rect x="105" y="35" width="224" height="242" rx="9" transform="rotate(10 105 35)" fill="var(--home-sage)" stroke="currentColor" stroke-opacity=".2"/><rect x="80" y="36" width="230" height="248" rx="9" transform="rotate(-7 80 36)" fill="url(#home-paper)" stroke="currentColor" stroke-opacity=".24"/><g transform="rotate(-7 80 36)"><path d="M101 59H289M101 262H289" stroke="#405642" stroke-opacity=".3"/><rect x="101" y="76" width="188" height="103" rx="3" fill="#4c6856"/><circle cx="247" cy="104" r="13" fill="#d0d6ad"/><path d="m101 153 49-43 52 45 37-24 50 36v12H101Z" fill="#84997a"/><path d="m101 167 50-22 44 25 51-25 43 17v17H101Z" fill="#304c40"/><rect x="101" y="190" width="88" height="55" rx="3" fill="#a7b697"/><path d="m111 237 23-26 19 14 25-25v45h-67Z" fill="#6e886f"/><rect x="201" y="190" width="88" height="55" rx="3" fill="#c3b993"/><path d="M216 205h56m-56 10h40m-40 10h48" stroke="#776f50" stroke-opacity=".6" stroke-linecap="round"/></g><path d="m353 38 5 13 13 5-13 5-5 13-5-13-13-5 13-5Z" fill="var(--home-sage)"/><circle cx="47" cy="203" r="7" stroke="var(--home-sage)" stroke-width="3"/><circle cx="365" cy="224" r="3" fill="currentColor" opacity=".45"/></svg><span>STORY → FRAMES → ALBUM</span></div>`;
}

function renderHome() {
  const modules=homeModuleItems();
  return `<section id="mio-home" aria-labelledby="home-title">
    <header class="home-hero"><div class="home-intro"><div class="home-eyebrow"><span></span>MIO / YOUR LOCAL CREATIVE STUDIO</div><h1 id="home-title"><span>让故事成帧，</span><span class="home-title-accent">让灵感成册。</span></h1><p class="home-lead">一个属于你的本地漫画工作室。把灵感写成分镜，连接喜欢的图像服务，再将每一帧编排成可以阅读、分享的画册。</p><div class="home-hero-actions">${btn('从一幕开始','plus','home-open','data-route="1" data-view="stories"','primary')}${btn('浏览我的画册','arrow','home-open','data-route="0"','ghost')}</div></div>${homeArtwork()}</header>
