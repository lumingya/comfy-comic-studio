...
function quickStartSettings(){return `<section class="settings-section"><h2>快速开始</h2><p>开箱检查的进度，以及离线三幕练习。</p><div class="row wrap">${btn('打开快速开始','play','guide-open','','primary')}${btn('先用离线练习体验','story','guide-practice')}</div></section>`}
