...
function renderSmartMapper() {
 ...
 ${
   mapperUI.tab === "bindings"
     ? `<div class="wm-filterbar"><label class="wm-search">${icon("search", "sm")}${searchInput({id:'wm-binding-search',value:mapperUI.search,placeholder:'搜索名称、节点或字段…',label:'搜索映射',controls:'wm-binding-rows'})}</label><div class="wm-segments" aria-label="筛选映射">${[
         ["all", "全部"],
         ["enabled", "已启用"],
