...
EXCLUDED = {'__pycache__', 'node_modules', '.git', '.cache', 'data', 'images',
            'build', 'dist', 'test-results', '.venv', '.mio-updates', 'releases'}
...
def build(output):
    ...
    manifest = {'name': 'Mio', 'version': version, 'kind': 'complete-source-runtime',
                'upstreamBaseline': '4c1618276154fccd28e991130dfef0a09edb6c5a', 'runtime': 'Python >= 3.10 + Pillow >= 11.3,<13; computed variables: Node.js >= 20; Git installs: Git',
