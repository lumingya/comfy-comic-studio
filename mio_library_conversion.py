...
from mio_library import (FileLibrary, LibraryError, KINDS, ID, MAX_ASSET, atomic_write,
                         decode, digest, encode, image_refs, image_type, owned_path, sync_dir)
from mio_library_settings import FileSettings, binding, leaves
from mio_library_workspace import GROUPS, WorkspaceRepository
    ...
    def project_execution(self, config):
        ...
        try:
            ...
            if 'picture_edits' in tables:
                ...
                from mio_pictures import apply_record
